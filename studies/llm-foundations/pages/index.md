...
groups:
  - label: 先讀這篇
    ...
    pages: ["101"]
  - label: 核心機制深挖(任意順序)
    note: 都是 101 核心迴圈裡沒展開的細節,彼此獨立,讀完 101 之後想先看哪個都可以。
    parallel: true
    pages: [tokenizer-schemes-and-weight-tying, positional-encoding, cross-entropy-teacher-forcing, decoding-strategies]
  - label: 為什麼這樣就夠
